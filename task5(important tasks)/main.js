...
window.onscroll =function () {
  if (window.pageYOffset>=400) {
    ...
    downBtn.onclick =function () {
      ...
      // console.log("____________"+document.body.scrollHeight);
    }
  }
}
// //////////////////////////
...
var task9In =document.getElementById('task9In');
var i=1
window.addEventListener("keydown", checkKeyPressed, false);

function checkKeyPressed(evt) {
  document.getElementById('task9Text').textContent = (task9In.value).length
  // if (i>0) {
  //   if (evt.keyCode == "8") { // 8 mean Backspace
  //     i--;
  //     document.getElementById('task9Text').textContent = i;
  //   }else {
  //     document.getElementById('task9Text').textContent = i;
  //     i++;
  //   }
